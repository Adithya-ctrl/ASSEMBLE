...
10. Exposes backend-only structural stress, minimum-disruption recompilation and one-action capability-frontier APIs.

Item 10 has no current frontend surface. Community roles deliberately do not gate the planning or M7 routes.
