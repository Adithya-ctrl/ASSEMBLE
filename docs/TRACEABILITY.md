...
| Six-action truth-preserving interface | `frontend/app/page.tsx`, `frontend/lib/api.ts` | production browser Clinic journey |
| Basic empty-path and Clinic successor-path Project forms | `frontend/app/page.tsx` | production browser Basic and Clinic journeys |
| Proof provenance and stale-response protection | `frontend/app/page.tsx`, `frontend/lib/api.ts` | browser pre-verification absence, late-response Reset/switch replay, duplicate-submit replay, source inspection; frontend typecheck/lint/build |
| Equivalent graph/list facts | `frontend/app/page.tsx` | browser exact normalized eight-block parity comparison |
| Semantic status, trace table, live journey updates and fresh Project-proof focus | `frontend/app/page.tsx` | browser announcement, semantic-table and Project proof-inspector replay |
...
| --- | --- | --- |
| FR-001 | `backend/app/fixture.py`, `frontend/app/page.tsx` | demo/API tests and browser S0 inventory replay |
| FR-002 | `frontend/app/page.tsx` | normalized eight-block graph/list comparison |
| FR-003 | `frontend/app/page.tsx`, `backend/app/models.py` | browser initiative switching and model tests |
...
| FR-010 | `frontend/app/page.tsx` | production browser transition-before-verify replay |
| FR-011 | `frontend/app/page.tsx` | Basic base-proof and Clinic successor-proof form gates |
...
| FR-014 | `frontend/app/page.tsx` | fresh verification, source-plan/path/lineage/catalyst-output rendering and inspector-focus replay |
| FR-015 | `frontend/app/page.tsx` | browser Reset replay after completed Clinic Project |
| FR-016 | `frontend/app/page.tsx`, `frontend/app/globals.css` | keyboard, view-group, contrast, status, and target checks |
| FR-017 | `frontend/app/page.tsx` | single live-region journey announcement replay |
...
| NFR-004 | `frontend/app/page.tsx`, `frontend/app/globals.css` | keyboard, focus, status, live, target, contrast, motion checks |
| NFR-005 | `frontend/app/globals.css` | 1440/1280/768/390/320 and 200% reflow checks |
| NFR-006 | loading state and bounded solver configuration | interactive journey and solver statistics |
| NFR-007 | `backend/app/main.py`, frontend workflow-generation/abort protections | stable-envelope API tests and all-route stale/duplicate-response replay |
...
| NFR-011 | `frontend/app/page.tsx`, `frontend/app/globals.css` | 320/1440 parity: 23 controls, 3 fields, same headings, 26 Project evidence items, 7 team facts, no overflow or sub-44px target |
