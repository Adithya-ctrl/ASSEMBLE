...
| Chronological human availability without source mutation | `frontend/lib/availability.ts`, `frontend/components/community/CommunityInventory.tsx` | focused copy-on-sort unit regression plus Leo browser detail replay |
